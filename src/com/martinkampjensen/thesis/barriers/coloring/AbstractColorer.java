...
/**
 * This class provides a skeletal implementation of the {@link Colorer}
 * interface, to minimize the effort required to implement this interface.
 * <p>
 * An implementation only needs to implement
 * {@link Colorer#color(Node)}.
 */
public abstract class AbstractColorer implements Colorer
{
	protected AbstractColorer()
	{
	}
	 ...
	 */
	@Override
	public final void color(BarrierForest forest)
	{
		if(forest == null) {
